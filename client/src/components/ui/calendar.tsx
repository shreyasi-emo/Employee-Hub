...
// App-standard month navigation: a single unified control — "‹ June 2026 ›" —
// with the arrows on either side of the month label (no separate circular buttons).
export function MonthCaption({ displayMonth }: { displayMonth: Date }) {
...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      components={{
        // App-standard unified month nav by default; callers may still override.
