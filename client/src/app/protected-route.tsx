...
// whose API already scopes data per role (dashboard, attendance, leave, my-requests/approvals,
// logistics, requests, resources, reimbursements, own profile) are intentionally left open — the
