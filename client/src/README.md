...
| Company Workspace | `/company-workspace` | [features/company-workspace/pages/company-workspace-page](features/company-workspace/pages/company-workspace-page.tsx) | Everyone (12 roles) |
...
| My Approvals | `/my-approvals` | [features/company-workspace/pages/my-approvals-page](features/company-workspace/pages/my-approvals-page.tsx) | — |
| Reimbursement Review | `/my-approvals/reimbursement/:id` | [features/company-workspace/reimbursements/pages/reimbursement-review-page](features/company-workspace/reimbursements/pages/reimbursement-review-page.tsx) | — |
| My Requests | `/my-requests` | [features/company-workspace/pages/my-requests-page](features/company-workspace/pages/my-requests-page.tsx) | Everyone (12 roles) |
| My Requests | `/my-requests/:tab` | [features/company-workspace/pages/my-requests-page](features/company-workspace/pages/my-requests-page.tsx) | — |
...
| Reimbursements | `/reimbursements` | [features/company-workspace/reimbursements/pages/reimbursements-page](features/company-workspace/reimbursements/pages/reimbursements-page.tsx) | — |
| Requests | `/requests` | [features/company-workspace/pages/requests-page](features/company-workspace/pages/requests-page.tsx) | Everyone (12 roles) |
...
- **`features/auth/`** — pages
- **`features/company-workspace/`** — api, components, office-purchases, pages, procurement, reimbursements, shared, tickets, travel
